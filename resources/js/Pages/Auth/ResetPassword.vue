    ...
    <GuestLayout>
        ...
        <div class="space-y-8">
            ...
            <div class="text-center">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">{{ t.auth.resetPassword.title }}</h2>
                <p class="text-gray-600 dark:text-gray-300">Enter your new password below</p>
            </div>

            <form @submit.prevent="submit" class="space-y-6">
                <div>
                    <InputLabel for="email" :value="t.auth.resetPassword.email" class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block" />
                ...
                <div>
                    <InputLabel for="password" :value="t.auth.resetPassword.password" class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block" />
                ...
                <div>
                    ...
                    >
                        ...
                        {{ form.processing ? t.auth.resetPassword.resetting : t.auth.resetPassword.resetPassword }}
                    </PrimaryButton>
                </div>
            </form>
        </div>
